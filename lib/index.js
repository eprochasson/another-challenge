...
var hours = {
    ...
    merge: function(values){
        ...
        _.each(_.keys(result), function(k){
            if(result[k]){
                tmp.push({date: k, times: Interval.merge(Interval.str2intervals(result[k]), true)});
            }
        });

        tmp = _.sortBy(tmp, function(datetime){
...
console.log(hours.parse('Mon.-Fri.: 12:00-14:30； 18:00-22:30\nSat.-Sun.&Public Holidays: 11:30-15:00; 18:00-22:30'));
